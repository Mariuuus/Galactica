...
data class ConnectionLobbyPayload(val timestamp: Long, val rows: Int, val cols : Int, val planets: Int, val start: Boolean)  : ConnectionPayload {
    override fun encode(): String = "$timestamp;$rows;$cols;$planets;$start"
