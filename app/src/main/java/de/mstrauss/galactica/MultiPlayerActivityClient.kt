...
class MultiPlayerActivityClient : AppCompatActivity() {
    ...
    companion object {
        ...
        fun createIntent(
            ...
            planetAmount: Int,
            randomSeed: Long
        ): Intent = Intent(context, MultiPlayerActivityClient::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_multi_player_client)
        ...
        game = MultiplayerGame(
            ...
            {},
            BluetoothConnectionManager.Role.CLIENT,
            randomSeed
        )
        ...
        val payload = ConnectionIngamePayload(timestamp = randomSeed, type= Type.JOINED, planetAmount)
